...
Asena.addCommand({pattern: 'list', fromMe: false, desc: Lang.GL}, (async (message, match) => {
  ...
  r_text[0] = "https://i.imgur.com/4Oir08c.jpeg";
    ...
    await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `*ғɪᴅʜᴀ ᴍᴡᴏʟ [ᴡʜᴀᴛsᴀᴘᴘ ᴘᴜʙʟɪᴄ⛒ʙᴏᴛ]*

*ᴅᴇᴠᴇʟᴏᴘᴇʀ ɪᴛs-ᴍᴇ ͢⁨ʜʏᴘᴇᷫʀⷦ¹*

*ɢɪᴛʜᴜʙ: https://github.com/Hypersir/Fidha-Mwol*
