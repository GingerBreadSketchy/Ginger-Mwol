...
Asena.addCommand({pattern: 'fidha', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Hyperine tholpikkaan ningalkavilla. Jeevitathil hyperine tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Fidha says i love you 😘";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Fidha ,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe hyper pazhaya hyper thanneya...😎\n\n";
