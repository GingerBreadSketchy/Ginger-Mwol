...
module.exports = {
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.imgur.com/qkuvZvp.jpeg' : process.env.ALIVE_LOGO,
    ...
    PHONE: process.env.NUMBER === undefined ? '+917025967090' : process.env.NUMBER,
